...
public class DBAdapter extends SQLiteOpenHelper implements Serializable {
	...
	public static final String KEY_ROWID="_id";//行id
	...
	public static final String KEY_ACT_DESC="desc";//活动描述
	...
	public static final String[] ActFields=new String[]{KEY_ROWID, KEY_ACT_ID, KEY_ACT_ADDR,KEY_ACT_LOC,KEY_ACT_DAY,
	...
	public static final String KEY_PERSON_ID="person_id";//活动人编号
	public static final String KEY_PERSON_ACT_ID="act_id";//对应活动id
	public static final String KEY_PERSON_NAME="name";//参加活动人姓名
	public static final String KEY_PERSON_CURLOC="current_loc";//当前位置
	public static final String KEY_PERSON_ARRIVE_STATE="arrive_state";//是否到达活动
	public static final String KEY_PERSON_ARRIVE_TIME="arrive_time";//到达时间
	public static final String KEY_PERSON_LEAVE_STATE="leave_state";//是否请假
	public static final String KEY_PERSON_REASON_DESC="reason_desc";//请假原因
	public static final String KEY_PERSON_HOST="host";//参与者还是主办人
	public static final String KEY_PERSON_USER_NAME="user_name";//用户名
	public static final String KEY_PERSON_USER_ID="user_id";//用户id
	
	public static final String[] PersonFields= new String[]{KEY_PERSON_ID,KEY_PERSON_ACT_ID,KEY_PERSON_NAME,KEY_PERSON_CURLOC,
	...
	public static final String KEY_USER_USERNAME="user_name";//用户名
	public static final String KEY_USER_PASSWORD="user_password";//密码
	public static final String KEY_USER_NAME="name";//姓名
	public static final String KEY_USER_CURRENT="current";
    ...
    public static final String DATABASE_ACT_TABLE ="t_act";
    public static final String DATABASE_PERSON_TABLE ="t_person";
    public static final String DATABASE_USER_TABLE ="t_user";
    
    public static final int DATABASE_VERSION = 2;

    public static final String DBCREATE_ACT_TABLE="create table "+DATABASE_ACT_TABLE+" ("
    		...
    		+ "act_state text "
    		+ ");";
    public static final String DBCREATE_PERSON_TABLE="create table "+DATABASE_PERSON_TABLE+" ("
    		+ "_id integer primary key autoincrement,"
    		+ "person_id text, "
    		+ "act_id text, "
    		+ "name text, "
    		...
    		+ "user_id text "    
    		+ ");";
    public static final String DBCREATE_USER_TABLE="create table "+DATABASE_USER_TABLE+" ("
    		+ "_id integer primary key autoincrement, "
    		+ "user_id text, "
    		+ "user_name text, "
    		+ "user_password text, "
